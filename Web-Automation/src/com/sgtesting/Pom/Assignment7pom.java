...
public class Assignment7pom {
  ...
  private static void modifyproject()
  {
	  try
	  {
		  ...
		  Thread.sleep(2000);
		  oPage1.getclickonselenium().click();
		  oPage1.getclickonemptyfieldproject().clear();
		  Thread.sleep(2000);
		  oPage1.getclickonemptyfieldproject().sendKeys("newselenium");
		  oPage1.getclickonclosebutton().click();
	  }catch (Exception e) {
		e.printStackTrace();
	}
}
